    ...
    <div>
      <Box>
        <Typography style={{ fontWeight: "bold" }} gutterBottom>
          <p className="text-base text-[#42424a] font-semibold mr-2">Add Department</p>
        </Typography>
      </Box>

      <Grid container spacing={2} sx={{ marginTop: 1 }}>
        <Grid item xs={3}>
          <p className="text-xs mb-1">Hospital:</p>
          <TextField variant="outlined" fullWidth select disabled  sx={{ 
            ...
            <MenuItem value="hospital_id">Hospital Name</MenuItem>
          </TextField>
        </Grid>

        <Grid item xs={3}>
          <p className="text-xs mb-1">Department Name:</p>
