...
const StressedQuestion3 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Have you had recurring nightmares or flashbacks?
      </Typography>
