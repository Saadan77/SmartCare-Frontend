...
const StressedQuestion4 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Do you avoid places or people that remind you of a traumatic event?
      </Typography>
