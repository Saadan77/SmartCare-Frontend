...
const StressedQuestion10 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Have you noticed a change in your relationships since the trauma?
      </Typography>
