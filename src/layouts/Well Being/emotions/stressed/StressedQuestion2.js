...
const StressedQuestion2 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Do you feel disconnected from others due to past experiences?
      </Typography>
