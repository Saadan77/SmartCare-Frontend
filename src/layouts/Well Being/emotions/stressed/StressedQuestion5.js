...
const StressedQuestion5 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Do you feel overly alert or on edge most of the time?
      </Typography>
