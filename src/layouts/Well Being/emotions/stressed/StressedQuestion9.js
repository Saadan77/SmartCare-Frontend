...
const StressedQuestion9 = ({ onNext, selectedAnswer: initialAnswer }) => {
  ...
  return (
    <>
      ...
      >
        Do you feel numb or detached from your emotions?
      </Typography>
