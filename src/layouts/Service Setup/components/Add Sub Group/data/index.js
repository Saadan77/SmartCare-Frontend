...
export default function data() {
  ...
  const rows = [
    {
      groupName: <MDTypography variant="caption" fontWeight="medium">Laboratory</MDTypography>,
      subgroupName: <MDTypography variant="caption" fontWeight="medium">Blood Bank</MDTypography>,
